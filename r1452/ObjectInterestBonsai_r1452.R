...
p1_80 <- p1circle80 + geom_circle(aes(x0 = 793, y0 = 216, r = 80), color = "red")
...
#A total of 1296 points are within object 2 ROI.
...
points_in_circle3
#A total of 551 points are within object 2 ROI.
