rm(list = ls())
library(tidyverse)
ObjectInterest1 <- read_csv("240726_r1576_0_baseline_object-interest.csv")
...
ObjectInterest1 <- ObjectInterest1 %>%
  filter(Value.Item1.Item1.Item2>0)
...
ObjectInterest2 <- read_csv("240726_r1576_1_baseline_object-interest.csv")
...
#To delete the first 10 seconds of the video
ObjectInterest2 <- ObjectInterest2 %>%
  filter(Value.Item1.Item1.Item2>64)
#Rename the centroid coordinates
ObjectInterest2 <- ObjectInterest2 %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2)
ObjectInterest2 <- ObjectInterest2 %>%
...
ObjectInterest3 <- read_csv("240726_r1576_2_baseline_object-interest.csv")
...
#To delete the first 10 seconds of the video
ObjectInterest3 <- ObjectInterest3 %>%
  filter(Value.Item1.Item1.Item2>30)
#Rename the centroid coordinates
ObjectInterest3 <- ObjectInterest3 %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2)
ObjectInterest3 <- ObjectInterest3 %>%
