rm(list = ls())
library(tidyverse)
ObjectInterest1 <- read_csv("240704_r1421_0_baseline_object-interest.csv")
...
ObjectInterest2 <- read_csv("240704_r1421_1_baseline_object-interest.csv")
...
ObjectInterest3 <- read_csv("240704_r1421_2_baseline_object-interest.csv")
