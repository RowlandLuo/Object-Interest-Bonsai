rm(list = ls())
library(tidyverse)
ObjectInterest1 <- read_csv("240704_r1423_0_baseline_object-interest.csv")
...
points_in_circle2
#A total of 1307 points are within object 1 ROI.
...
points_in_circle4
#A total of 696 points are within object 1 ROI.
