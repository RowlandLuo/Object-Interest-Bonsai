rm(list = ls())
library(tidyverse)
ObjectInterest1 <- read_csv("240726_r1574_0_similar_object-interest.csv")
...
ObjectInterest1 <- ObjectInterest1 %>%
  filter(Value.Item1.Item1.Item2>63)
#Rename the centroid coordinates
ObjectInterest1 <- ObjectInterest1 %>%
  rename(pixelx = Value.Item1.Item3.X, pixely = Value.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2)
ObjectInterest1 <- ObjectInterest1 %>%
  select(!1)
ObjectInterest1 <- ObjectInterest1 %>%
  select(!15)
...
p1_130 <- p1circle130 + geom_circle(aes(x0 = 376, y0 = 164, r = 75), color = "red")
p1_130
radius <- 75
center_x1 <- 125
center_y1 <- 398
...
ObjectInterest2 <- read_csv("240726_r1574_1_baseline_object-interest.csv")
...
#To delete the first 10 seconds of the video
ObjectInterest2 <- ObjectInterest2 %>%
  filter(Value.Item1.Item1.Item2>138)
#Rename the centroid coordinates
ObjectInterest2 <- ObjectInterest2 %>%
...
#Add ROI one onto the scatterplot
library(ggforce)
p2circle130 <- p2 + geom_circle(aes(x0 = 125, y0 = 398, r = 75), color = "blue")
p2_130 <- p2circle130 + geom_circle(aes(x0 = 376, y0 = 164, r = 75), color = "red")
p2_130
radius <- 75
center_x1 <- 125
center_y1 <- 398
...
ObjectInterest3 <- read_csv("240726_r1574_2_baseline_object-interest.csv")
...
#To delete the first 10 seconds of the video
ObjectInterest3 <- ObjectInterest3 %>%
  filter(Value.Item1.Item1.Item2>41)
#Rename the centroid coordinates
ObjectInterest3 <- ObjectInterest3 %>%
  rename(pixelx = Value.Item1.Item1.Item3.X, pixely = Value.Item1.Item1.Item3.Y, TimePoint = Value.Item1.Item1.Item2)
ObjectInterest3 <- ObjectInterest3 %>%
...
#Add ROI one onto the scatterplot
library(ggforce)
p3circle130 <- p3 + geom_circle(aes(x0 = 125, y0 = 398, r = 75), color = "blue")
p3_130 <- p3circle130 + geom_circle(aes(x0 = 376, y0 = 164, r = 75), color = "red")
p3_130
radius <- 75
center_x1 <- 125
center_y1 <- 398
